...
export const FORM_PARTIAL_RISCOSSO =
  "Il riscosso è stato aggiornato, ma non siamo riusciti a notificare l'amministrazione. Ti preghiamo di notificare tu l'aggiunta";
