...
export const ERROR_INVALID_URL =
  '❌ Questo url non è valido. Ricontrolla per favore';
export const ERROR_INVALID_MOBILE =
  '❌ Questo numero non è valido. Ricontrolla per favore';
...
export const FORM_FAIL_MESSAGE =
  '❌ Non siamo riusciti a inviare il messaggio. Ricontrolla per favore';
...
export const FORM_SUCCESS_RESET =
  '✔️ Riceverai la mail di reset in qualche secondo';
